...
if [ -z "$ANDROIDSDK" ]; then export ANDROIDSDK=~/android-tools/adt-bundle-linux-x86_64-20130514/sdk; fi
if [ -z "$ANDROIDAPI" ]; then export ANDROIDAPI=8; fi
if [ -z "$ANDROIDNDK" ]; then export ANDROIDNDK=~/android-tools/android-ndk-r8e; fi
